      ...
      <nav style={styles.navStyle}>
        ...
        {dropdownOpen && (
          <div style={styles.dropdownStyle}>
            ...
            <Link to="/events" style={styles.linkStyle} onClick={() => setDropdownOpen(false)}>Events</Link>
            {user ? (
              <button style={styles.logoutBtn} onClick={handleLogout}>Log ud</button>
            ) : (
              <Link to="/login" style={styles.linkStyle} onClick={() => setDropdownOpen(false)}>Login</Link>
            )}
          </div>
        )}
      </nav>
